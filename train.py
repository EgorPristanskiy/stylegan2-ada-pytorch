...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        'auto':      dict(ref_gpus=-1, kimg=5100,  mb=4, mbstd=-1, fmaps=-1,  lrate=-1,     gamma=-1,   ema=-1,  ramp=0.05, map=2), # Populated dynamically based on resolution and GPU count.
    ...
    if cfg == 'auto':
        ...
        spec.mb = max(4, gpus) # keep gpu memory consumption at bay
